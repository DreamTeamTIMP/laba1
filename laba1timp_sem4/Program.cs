    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            try
            {
                ...
                {
                    case "create":
                        if (args.Length < 2) throw new ArgumentException("Использование: Create <имя файла>");
                        manager.Create(args[1], 20); // 20 - размер строки имени
                        break;

                    case "open":
                        if (args.Length < 2) throw new ArgumentException("Использование: Open <имя файла>");
                        manager.Open(args[1]);
                        break;
                    ...
                    case "help":
                        ...
                        Console.WriteLine("Create <имя> - создать новый файл");
                        Console.WriteLine("Open <имя>   - открыть файл");
                        Console.WriteLine("Input <имя, тип>  - добавить компонент");
                        Console.WriteLine("Input <узел>/<деталь> - добавить деталь в узел");
                        ...
                        Console.WriteLine("Delete <компонент,комплектующий> - удалить комплектующее из спецификации компонента");
                        Console.WriteLine("Truncate     - сборка мусора");
                        Console.WriteLine("Restore * - сборка мусора");
